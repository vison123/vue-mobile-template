  ...
  <footer id='foot_guide'>
    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
      ...
      <defs>
        ...
        <symbol xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 40 40" id="homeActive">
          <defs>
    ...
    <section @click="gotoAddress({path: '/home'})" class="guide_item">
      <svg class="icon_style">
        <use xmlns:xlink="http://www.w3.org/1999/xlink"
             :xlink:href="$route.meta.selectedMenu === 'Home'? '#homeActive' : '#home'"></use>
      </svg>
      <span>首页</span>
    </section>
    <section @click="gotoAddress({path: `/search`})" class="guide_item">
      <svg class="icon_style">
        <use xmlns:xlink="http://www.w3.org/1999/xlink"
             :xlink:href="$route.meta.selectedMenu === 'Search'? '#findActive' : '#find'"></use>
      </svg>
      <span>搜索</span>
    </section>
    <section @click="gotoAddress('/order')" class="guide_item">
      <svg class="icon_style">
        <use xmlns:xlink="http://www.w3.org/1999/xlink"
             :xlink:href="$route.meta.selectedMenu === 'Order'? '#orderActive' : '#order'"></use>
      </svg>
      <span>订单</span>
    </section>
    <section @click="gotoAddress('/profile')" class="guide_item">
      <svg class="icon_style">
        <use xmlns:xlink="http://www.w3.org/1999/xlink"
             :xlink:href="$route.meta.selectedMenu === 'Profile'? '#profileActive' : '#profile'"></use>
      </svg>
      <span>我的</span>
    </section>
  </footer>
